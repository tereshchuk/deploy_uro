...
import 'create_profile_guest_page_model.dart';
export 'create_profile_guest_page_model.dart';

class CreateProfileGuestPageWidget extends StatefulWidget {
  const CreateProfileGuestPageWidget({
    super.key,
    required this.email,
  ...
  @override
  State<CreateProfileGuestPageWidget> createState() =>
      _CreateProfileGuestPageWidgetState();
}

class _CreateProfileGuestPageWidgetState
    extends State<CreateProfileGuestPageWidget> {
  late CreateProfileGuestPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateProfileGuestPageModel());
                        ...
                        Theme(
                          ...
                          child: Checkbox(
                            ...
                            onChanged: (newValue) async {
                              ...
                              if (newValue!) {
                                _model.countCheck = _model.getLegal?.length;
                                safeSetState(() {});
                              } else {
                                _model.countCheck = 0;
                                safeSetState(() {});
