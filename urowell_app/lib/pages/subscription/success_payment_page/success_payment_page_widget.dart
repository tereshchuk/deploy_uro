...
import 'success_payment_page_model.dart';
export 'success_payment_page_model.dart';

class SuccessPaymentPageWidget extends StatefulWidget {
  const SuccessPaymentPageWidget({super.key});

  @override
  State<SuccessPaymentPageWidget> createState() =>
      _SuccessPaymentPageWidgetState();
}

class _SuccessPaymentPageWidgetState extends State<SuccessPaymentPageWidget> {
  late SuccessPaymentPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SuccessPaymentPageModel());
