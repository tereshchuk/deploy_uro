...
import 'report_personal_information_page_model.dart';
export 'report_personal_information_page_model.dart';

class ReportPersonalInformationPageWidget extends StatefulWidget {
  const ReportPersonalInformationPageWidget({
    super.key,
  ...
  @override
  State<ReportPersonalInformationPageWidget> createState() =>
      _ReportPersonalInformationPageWidgetState();
}

class _ReportPersonalInformationPageWidgetState
    extends State<ReportPersonalInformationPageWidget> {
  late ReportPersonalInformationPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportPersonalInformationPageModel());
